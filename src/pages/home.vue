  ...
  <div>
    <el-container>
      ...
      <el-footer v-show="meta.footerShow">
        <!-- 店长 -->
        <div @click="$router.push({path: './manager-order-list'})" v-show="userType === 2">
          <img src="../assets/u1075.png">
          <div :style="{color: currentPath === '/manager-order-list' ? '#C39862' : '#333333'}">订单</div>
        </div>
        <div @click="$router.push({path: './driver-info2'})" v-show="userType === 2">
          <img src="../assets/u1080.png">
          <div :style="{color: currentPath === '/driver-info2' ? '#C39862' : '#333333'}">司机</div>
        </div>
        <div @click="$router.push({path: './manager-info1'})" v-show="userType === 2">
          <img src="../assets/mine2.png">
          <div :style="{color: currentPath === '/manager-info1' ? '#C39862' : '#333333'}">我的</div>
        </div>
        <!-- <div @click="$router.push({path: './manager-info1'})" v-show="userType === 'shop'">
          <img src="../assets/u1080.png">
          <div :style="{color: currentPath === '/manager-info1' ? '#C39862' : '#333333'}">我的</div>
        </div> -->
        <!-- 司机 -->
         <div @click="$router.push({path: './store-manager'})" v-show="userType === 4">
          <img src="../assets/home2.png">
          <div :style="{color: currentPath === './store-manager' ? '#C39862' : '#333333'}">门店</div>
        </div>
        <div @click="$router.push({path: './driver-info1'})" v-show="userType === 4">
          <img src="../assets/mine2.png">
          <div :style="{color: currentPath === './driver-info1' ? '#C39862' : '#333333'}">我的</div>
        </div>
        <!-- 普通用户 -->
