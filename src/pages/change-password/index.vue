  ...
  <div>
    <div class="pwd-con">
      ...
      <el-form-item label="原密码" class="pwd-item" prop="pws1">
        <el-input v-model="password.pws1" type="password" placeholder="请输入原密码"></el-input>
      </el-form-item>
      <el-form-item label="新密码" class="pwd-item" prop="pws2">
        <el-input v-model="password.pws2" type="password" placeholder="请输入新密码"></el-input>
      </el-form-item>
      <el-form-item label="确认新密码" class="pwd-item" prop="pws3">
        <el-input v-model="password.pws3" type="password" placeholder="请再次输入新密码"></el-input>
      </el-form-item>
